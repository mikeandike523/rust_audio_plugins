...
impl<'a, P: Param> ParamSlider<'a, P> {
    ...
    /// [`TextInputMessage`] messages and do something with it.
    ...
    /// (to avoid unnecessary duplicate parameter changes).
...
impl<'a, P: Param> ParamSlider<'a, P> {
    /// Convert this [`ParamSlider`] into an [`Element`] with the correct message.
